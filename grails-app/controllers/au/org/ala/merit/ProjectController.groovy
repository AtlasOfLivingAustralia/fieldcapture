...
class ProjectController {
    ...
    protected Map projectContent(Map project, user, String template, ProgramConfig config) {
        ...
        boolean canManuallyRegenerateReports = projectService.canManuallyRegenerateReports(project)
