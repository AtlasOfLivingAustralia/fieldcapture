...
<div class="btn-group pull-left" style="margin-top:4px;">
    ...
    <span data-bind="text:name() || 'embedded video'"></span> <i class="icon-question-sign" data-bind="popover:{content:'Embedded videos are not downloadable.  Please use the Documents tab to view the video.'}"></i>
    <span class="muted" data-bind="if:$data.attribution">
        <br/><small data-bind="text:attribution"></small>
    </span>
