<!-- ko stopBinding: true -->
<div id="attachDocument" class="modal" tabindex="-1" role="dialog">
            ...
            <div class="modal-body">
                <form class="form-horizontal validationContainer" id="documentForm">
                    ...
                    <div class="form-group row" data-bind="visible:settings.showSettings">
                        <label class="ol-form-label col-sm-4" for="public">Settings</label>
                        <div class="col-sm-8">
                    ...
                    <div data-bind="visible: !embeddedVideoVisible()">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <span class="btn btn-sm fileinput-button">
