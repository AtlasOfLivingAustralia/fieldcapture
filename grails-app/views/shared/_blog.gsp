...
<div id="${blogId}" class="blog"  data-bind="foreach:entries">
    <div class="blog-entry">
        <img class="blog-image floatleft float-start" data-bind="visible:imageUrl(), attr:{src:imageThumbnailUrl}">
        <i class="blog-icon floatleft float-start fa fa-4x" data-bind="visible:stockIcon(), css:stockIcon"></i>
        <div class="widget-news-right-body">
            <h4><span class="title" data-bind="text:title"></span><span class="floatright float-end" data-bind="text:formattedDate"></span></h4>
