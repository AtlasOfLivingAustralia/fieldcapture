    ...
    <tbody data-bind="foreach:projects">
        <tr>
            ...
            <td data-bind="click:toggleHistory">
                <div class="layout-container">
                    <em data-bind="visible:!historyVisible()">Show history </em><i class="see-more fa fa-plus pointer"></i><em data-bind="visible:historyVisible()">Hide history </em><i class="fa fa-minus see-more pointer"></i>
                </div>
            </td>
            <g:if test="${allowProjectRecommendation}">
