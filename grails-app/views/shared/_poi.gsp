    ...
    <div class="sp-slides">
        <g:each in="${images}" var="image">
            <div class="sp-slide">
                ...
                <img class="sp-image" data-src="${image.url}" alt="${image.name?:"Un-captioned image for project ${image.projectName}"}" title="${image.name?:"Un-captioned image for project ${image.projectName}"}"/>
