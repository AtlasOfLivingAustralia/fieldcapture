<form class="validationEngineContainer">
    ...
    <g:if test="${fc.userIsAlaOrFcAdmin() && editProgramId != null}">
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <span class="select2">
                   <g:select class="parentProgramId form-control" from="${allProgram}" data-bind="value:parentProgramId" optionKey="programId" name="name" id="parentProgramId" optionValue="name" noSelection="${['null' : 'No Parent']}"/>
                </span>
            </div>
