<form class="form-horizontal validationEngineContainer">
    ...
    <div class="row-fluid">
        <div class="well">
            ...
            <div class="control-group required">
                <label class="control-label span3" for="name">Name: <fc:iconHelp><g:message code="program.name.help"/></fc:iconHelp> </label>
                <div class="controls span9">
                    <input type="text" id="name" class="input-xxlarge" data-bind="value:name" data-validation-engine="validate[required]" placeholder="${g.message(code:'program.name.placeholder')}" ${!isNameEditable?'readonly="readonly"':''}>
                </div>
            </div>
            <div class="control-group required">
                <label class="control-label span3" for="description">Description: <fc:iconHelp><g:message code="program.description.help"/></fc:iconHelp></label>
                <div class="controls span9">
                    <textarea rows="3" class="input-xxlarge" data-bind="value:description" data-validation-engine="validate[required]" id="description" placeholder="${g.message(code:'program.description.placeholder')}"></textarea>
                    <br/><button class="btn popup-edit" data-bind="click:editDescription"><i class="icon-edit"></i> Edit with Markdown Editor</button>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label span3" for="url">Web Site URL: <fc:iconHelp><g:message code="program.webUrl.help"/></fc:iconHelp></label>
                <div class="controls span9">
                    <input type="text" class="input-xxlarge" id="url" data-bind="value:url" data-validation-engine="validate[custom[url]]" placeholder="${g.message(code:'program.webUrl.placeholder')}">
                </div>
            </div>
    ...
    <div class="row-fluid">
        <div class="well">
            ...
            <div class="control-group">
                <label class="control-label span3" for="logo">Program Logo: <fc:iconHelp><g:message code="program.logo.help"/></fc:iconHelp>:</label>
            ...
            <div class="control-group">
                <label class="control-label span3" for="mainImage">Feature Graphic<fc:iconHelp><g:message code="program.mainImage.help"/></fc:iconHelp>:</label>
                <div class="span6" style="text-align:center;background:white">
