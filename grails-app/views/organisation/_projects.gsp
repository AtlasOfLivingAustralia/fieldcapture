    ...
    <div class="row-fluid row ">
        <a href="${createLink(controller: 'project', action: 'create', params: [organisationId: organisation.organisationId])}"
           class="btn btn-small pull-right">
            <i class="icon-file fa fa-file"></i>&nbsp;<g:message code="project.create.crumb"/></a>
    </div>
</g:if>
...
<g:else>
    <div class="row-fluid row">
        <span class="span12 col-sm-12"><h4>${organisation.name?.encodeAsHTML()} is not currently involved in any projects.</h4></span>
    </div>
</g:else>
