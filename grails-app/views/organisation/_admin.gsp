    ...
    <div class="row-fluid">
        ...
        <p><a href="${g.createLink(action:'editAnnouncements',id:organisation.organisationId)}"><button class="btn btn-small btn-info admin-action" style="width:200px;"><i class="icon-edit icon-white"></i> <span class="btn-info">Edit Announcements</span></button></a> Bulk edit the announcements for all projects managed by this organisation</p>
        </g:if>
