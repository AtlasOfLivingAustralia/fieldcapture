    ...
    <div class="overview">
        ...
        <g:if test="${project.serviceProviderName}">
            <div class="row mb-2">
                ...
                <div class="col-sm-9">${project.serviceProviderName}</div>
            </div>
        </g:if>
        <div class="row mb-2">
            <div class="col-sm-3 title">Funded by</div>
            <div class="col-sm-9">${project.associatedProgram} ${project.associatedSubProgram?:''}</div>
        </div>
        <div class="row mb-2">
            <div class="col-sm-3 title">Funding</div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-9"><g:formatDate format="dd MMM yyyy" date="${au.org.ala.merit.DateUtils.parse(project.plannedStartDate).toDate()}"/></div>
        </div>
        <div class="row mb-2">
            <div class="col-sm-3 title">Project finish</div>
            <div class="col-sm-9"><g:formatDate format="dd MMM yyyy" date="${au.org.ala.merit.DateUtils.parse(project.plannedEndDate).toDate()}"/></div>
        </div>
        <div class="row mb-2">
        ...
        <div class="row mb-2" id="report-status">
            <div class="col-sm-3 title">Current report status</div>
            <div class="col-sm-9" data-bind="text:currentStatus"></div>
        </div>

        <div class="row mb-2">
            <div class="col-sm-3 title">Summary generated</div>
            <div class="col-sm-9"><g:formatDate format="yyyy-MM-dd HH:mm:ss" date="${new Date()}"/></div>
        </div>
        <div class="row mb-2 generated-by">
            <div class="col-sm-3 title">Summary generated by</div>
            <div class="col-sm-9"><fc:currentUserDisplayName></fc:currentUserDisplayName></div>
        </div>
        <div class="row mb-2">
            <div class="col-sm-3 title">Position / role:</div>
            <div class="col-sm-9">${role}</div>
        </div>
    </div>
    ...
    <g:if test="${metrics?.other  && ('Progress of outputs without targets' in content)}">
        ...
        <div class="outputs-without-targets dashboard">
            <g:each in="${metrics.other?.entrySet()}" var="metric" status="i">
                ...
                <div class="row mb-2 well well-small">
                    <h3>${metric.key}</h3>
                    <g:each in="${metric.value}" var="score">
                                <fc:renderScore score="${score}" printable="${printable}"></fc:renderScore>
        ...
        <g:each in="${orderedStageNames}" var="stage">
            ...
            <g:each in="${activitiesByStage[stage]}" var="activity">
                ...
                <div class="activity-header">
                    <div class="row mb-2">
                        <div class="col-sm-3 title">Activity type</div>
                        <div class="col-sm-9">${activity.type}</div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-3 title">Status</div>
                        <div class="col-sm-9">${activity.progress}</div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-3 title">Major theme</div>
                        <div class="col-sm-9">${activity.mainTheme}</div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-3 title">Start date</div>
                        <div class="col-sm-9">${DateUtils.isoToDisplayFormat(activity.startDate ?: activity.plannedStartDate)}</div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-3 title">End date</div>
                        <div class="col-sm-9">${DateUtils.isoToDisplayFormat(activity.endDate ?: activity.plannedEndDate)}</div>
                    </div>
                    <g:if test="${activity.reason}">
                        <div class="row mb-2">
                            <div class="col-sm-3 title">Reason</div>
                            <div class="col-sm-9">${activity.reason}</div>
                        </div>
                    </g:if>
