        ...
        <table class="table control-approach-threat">
            ...
            <tr>
                <td class="approach-current">
                    <select class="form-select form-select-sm" style="width: 30%;" data-bind="addValueToOptionsIfMissing:true, options: $parent.controls, value:couldBethreatToSpecies,optionsCaption: 'Please select', disable: $parent.isProjectDetailsLocked()"></select>
                </td>
