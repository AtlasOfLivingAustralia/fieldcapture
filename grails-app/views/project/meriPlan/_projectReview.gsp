<table class="table">
    ...
    <tbody>
    <tr>
        <td><textarea class="form-control" rows="5" data-validation-engine="validate[required,maxSize[4000]]" data-bind="value:details.projectEvaluationApproach, disable: isProjectDetailsLocked()"></textarea></td>
    </tr>
    </tbody>
</table>
