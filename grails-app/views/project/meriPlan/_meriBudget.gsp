<div class="meri-budget">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <g:if test="${showThemeColumn}">
            <td class="budget-category"><select class="form-select form-select-sm" data-bind="options: $parent.projectThemes, optionsCaption: 'Please select', value:shortLabel, disable: $parent.isProjectDetailsLocked()"> </select></td>
            </g:if>
            ...
            <g:if test="${showActivityColumn}">
                <td class="budget-activities"><select class="form-select form-select-sm" multiple="multiple" data-bind="options:details.services.selectedServices, multiSelect2:{tags:false, value:activities}, disable: $parent.isProjectDetailsLocked()"></select></td>
            </g:if>
            <!-- ko foreach: costs -->
