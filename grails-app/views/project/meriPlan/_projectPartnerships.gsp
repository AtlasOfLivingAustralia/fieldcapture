<div id="project-partnership" class="well well-small">
    ...
    <table class="table">
        ...
        <tbody data-bind="foreach : details.partnership">
        <tr>
            <td class="index"> <span data-bind="text:$index()+1"></span></td>
            <td class="partner-name"> <textarea placeholder="${namePlaceHolder}" class="input-xlarge"  data-bind="value: partnerName, disable: $parent.isProjectDetailsLocked()" rows="3"></textarea> </td>
            <td class="partnership-nature"><textarea placeholder="${partnershipPlaceHolder}" class="input-xlarge" data-bind="value: partnerShipNature, disable: $parent.isProjectDetailsLocked()"  rows="5"></textarea></td>
            <td class="partner-organisation-type">
                <select class="input-xlarge" data-bind="options: $parent.organisations, value:organisationType, optionsCaption: 'Please select',disable: $parent.isProjectDetailsLocked()"></select>
                <textarea name="otherOrgType" id="otherOrgType" data-bind="enable: otherOrgSelected(), value: otherOrgType"></textarea>
            </td>
            <td class="remove">
