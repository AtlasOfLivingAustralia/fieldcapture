    ...
    <table class="table">
        ...
        <tr>
            ...
            <td class="partner-organisation-type">
                <select class="form-select form-select-sm mb-1" data-bind="addValueToOptionsIfMissing:true, options: $parent.organisations, value:data3,optionsCaption: 'Please select', disable: $parent.isProjectDetailsLocked()"></select>
