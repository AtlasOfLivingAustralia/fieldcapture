...
<table class="table">
    ...
    <tr>
        <td class="outcome-priority">
            <select data-validation-engine="validate[required]" class="form-control form-control-sm"  data-bind="options:details.outcomes.selectablePrimaryOutcomes, value:details.outcomes.primaryOutcome.description, optionsCaption: 'Please select', disable: isProjectDetailsLocked()" >
            </select>
