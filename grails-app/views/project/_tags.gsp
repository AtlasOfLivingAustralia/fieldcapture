<div class="project-tags">
    ...
    <form>
        ...
        <select multiple="multiple" id="tags" data-bind="multiSelect2:{value:tags, placeholder:'Add your tag/s here', tags:false, templateResult:formatTag, data:transients.projectTags}" class="form-select form-select-sm input-small"></select>
