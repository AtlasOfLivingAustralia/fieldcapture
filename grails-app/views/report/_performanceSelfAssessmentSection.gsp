...
<tr>
    ...
    <td>
        <textarea class="form-control form-control-sm" data-validation-engine="validate[maxSize[2000]]" maxlength="2000" data-bind="value:evidenceFor${section.additionalPracticeQuestion.name}" data-prompt-position="topRight:-110"></textarea>
    </td>
</tr>
