...
<tr>
    ...
    <td class="evidence">
        <textarea data-validation-engine="validate[required,maxSize[2000]]" data-bind="textInput:evidenceFor${question.name}" data-prompt-position="topRight:-110"></textarea>
    </td>
</tr>
</g:each>
<tr>
    ...
    <td>
        <textarea data-validation-engine="validate[required,maxSize[2000]]" data-bind="value:evidenceFor${additionalPracticeQuestion.name}" data-prompt-position="topRight:-110"></textarea>
    </td>
</tr>
