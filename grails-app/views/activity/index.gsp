...
<!-- /ko -->
    ...
    <div class="form-actions" id="activity-nav">
        ...
        <div class="row-fluid" style="position:relative">
            <a class="btn pull-left" data-bind="attr:{title:previousActivity().description, href:previousActivityUrl()}, enable:hasPrevious()"><i class="fa fa-arrow-left fa-2x text-center" style="vertical-align: middle;"></i> &nbsp; <span data-bind="text:previousActivity().type" style="vertical-align: middle;"></span></a>
            ...
            <!-- ko if:hasNext() -->
                <a class="btn pull-right" data-bind="attr:{title:nextActivity().description, href:nextActivityUrl()}"><span data-bind="text:nextActivity().type" style="vertical-align: middle;"></span> &nbsp; <i class="fa fa-arrow-right fa-2x text-center" style="vertical-align: middle;"></i></a>
            <!-- /ko -->
            <!-- ko if:!hasNext() -->
