...
security.cas.uriFilterPattern = "/user/.*,/site/(?!index).*,/project/(?!index).*,/activity/(?!index).*,/output/(?!index).*,/image/(?!index).*,/admin/.*,/proxy/speciesListPost,/ajax/keepSessionAlive" // pattern for pages that require authentication
