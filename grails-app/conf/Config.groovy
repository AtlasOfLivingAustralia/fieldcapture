...
security.cas.authenticateOnlyIfLoggedInPattern = "/,/;.*,/project/index.*,/site/index.*,/activity/index.*,/output/index.*,/ajax/keepSessionAlive,/search/.*" // pattern for pages that can optionally display info about the logged-in user
