...
class ReportServiceSpec extends Specification {
    ...
    void "reports can be regenerated correctly when a project start date is moved forward"() {
        ...
        then:
        1 * webService.doPost(_, [reportId:'1', fromDate: '2015-08-01T00:00:00Z', toDate: '2015-12-31T13:00:00Z', dueDate: '2016-02-12T13:00:00Z', type: 'Activity', name: 'Stage 1', description: "Stage 1 for project", projectId: 'p1'])
    ...
    void "no stage overlap should occur when an existing approved report exists with misaligned times"() {
        ...
        project.reports = [
                [reportId:'1', fromDate: '2016-01-01T00:00:00Z', toDate: '2016-07-01T00:00:00Z', dueDate: '', type: 'Activity', name: 'Stage 1', description: "Stage 1 for project", projectId: 'p1', publicationStatus:ReportService.REPORT_APPROVED],
                [reportId:'2', fromDate: '2016-07-01T00:00:00Z', toDate: '2017-01-01T00:00:00Z', dueDate: '', type: 'Activity', name: 'Stage 2', description: "Stage 2 for project", projectId: 'p1']]
        projectService.get(_, _) >> project
