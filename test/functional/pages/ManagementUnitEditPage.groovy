...
class ManagementUnitPage extends ReloadablePage {
    ...
    static content = {
        ...
        serviceProviderSelection(required:false){$('input#organisationSelection', 0)}
        serviceProviderAutoCompleteUI(required:false){$('ul.ui-autocomplete', 0)}
        serviceProviderAutoCompleteList(required:false){$('ul.ui-autocomplete li')}
