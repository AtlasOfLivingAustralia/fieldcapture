...
class GmsMapper {
    ...
    def projectMapping = [
            ...
            PORTFOLIO:[name:'portfolio', type:'lookup', mandatory:true, description: 'Agriculture / Environment / Both', values:['Agriculture':'Agriculture', 'Environment':'Environment', 'Environment and Agriculture':'Environment and Agriculture']],
