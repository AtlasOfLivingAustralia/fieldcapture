...
enum SettingPageType {
    ...
    REEF_2050_FINAL_REPORT ("reef2050FinalReport", "Reef 2050 Plan Final Action Report", "fielddata.reef2050Final.report"),
    ...
    ACTIVITY_LOCK_STOLEN_EMAIL_SUBJECT('lockStolenSubject', 'Subject line when someone overrides a lock', 'fielddata.lock.subject'),
    ACTIVITY_LOCK_STOLEN_EMAIL('lockStolenEmail', 'Email content when someone overrides a lock', 'fielddata.lock.body'),
    PROJECT_LOCK_STOLEN_EMAIL_SUBJECT('projectLockStolenSubject', 'Subject line when someone overrides a project MERI Plan lock', 'fielddata.project_lock.subject'),
    PROJECT_LOCK_STOLEN_EMAIL('projectLockStolenEmail', 'Email content when someone overrides a project MERI Plan lock', 'fielddata.project_lock.body'),
