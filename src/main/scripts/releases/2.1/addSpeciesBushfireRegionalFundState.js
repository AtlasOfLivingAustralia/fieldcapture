...
load("uuid.js");
var subprograms = ["Regional Fund for Wildlife and Habitat Bushfire Recovery (the Regional Fund) - States"]
...
var projectConfig = {
    priorities: [
        ...
        {
            "category": "Plant species",
            "priority": "Acacia bynoeana"
        },
        {
            "category": "Plant species",
            "priority": "Asperula asthenes"
        },
        {
            "category": "Plant species",
            "priority": "Carex klaphakei"
        },
        {
            "category": "Plant species",
            "priority": "Darwinia peduncularis"
        },
        {
            "category": "Plant species",
            "priority": "Eucalyptus glaucina"
        },
        {
            "category": "Plant species",
            "priority": "Grevillea raybrownii"
        },
        {
            "category": "Plant species",
            "priority": "Leucopogon fletcheri subsp. fletcheri"
        },
        {
            "category": "Plant species",
            "priority": "Olearia cordata"
        },
        {
            "category": "Plant species",
            "priority": "Prostanthera discolor"
        },
        {
            "category": "Plant species",
            "priority": "Thelymitra kangaloonica"
        },
        {
...
subprograms.forEach(function (subprogram){
    ...
    while(program.hasNext()){
        var p = program.next();
        if (p.name === "Regional Fund for Wildlife and Habitat Bushfire Recovery (the Regional Fund) - States"){
