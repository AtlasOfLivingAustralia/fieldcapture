...
var activitiesReef2050Implementation = [
    {
        ...
        list: [
            ...
            {name:"Annual Stage Report", description:"", type:"Activity"}
        ]
    },
    {
...
var activitiesReef2050PlanActionReporting = [
    {name:"Reporting",
        list:[
            {name:"Reef 2050 Plan Action Reporting 2018",description:"",type:"Report"}
        ]
    },
    {name:"Reports",
        list:[
            {name:"Reef 2050 Plan Action Reporting",description:"",type:"Report"}
        ]
    }
    ]
