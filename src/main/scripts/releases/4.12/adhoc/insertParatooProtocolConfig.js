var protocols = {
    ...
    "01689a85-ddef-491b-a0ca-e53f5c1d2413": {
        "name": "Herbarium Determinations - Field",
        "usesPlotLayout": true,
        "tags": ["survey"],
        "apiEndpoint": "determination-surveys",
        "overrides": {
            "dataModel": {
                "determination.determined_species_information.full_scientific_name": {
                    "dataType": "species"
                }
            }
        }
    },
    "0512ce08-51d3-4fe2-9555-428842acb27f": {
        "name": "Herbarium Determinations",
        "usesPlotLayout": true,
        "tags": ["survey"],
        "apiEndpoint": "determination-surveys",
        "overrides": {
