    ...
    it("will generate a URL based on the supplied properties", function() {
        ...
        jasmine.clock().withMock(function() {
            ...
            try {
                ...
                expect(suppliedUrl).toEqual("/html?fromDate=2018-10-01T14:00:00Z&toDate=2019-01-01T13:00:00Z&sections=Project+risks+changes&orientation=portrait");
                viewModel.generateRisksReportPDF();
                expect(suppliedUrl).toEqual("/pdf?fromDate=2018-10-01T14:00:00Z&toDate=2019-01-01T13:00:00Z&sections=Project+risks+changes&orientation=portrait");
            }
            finally {
