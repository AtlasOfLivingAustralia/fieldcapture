...
class ProjectServiceSpec extends Specification implements ServiceUnitTest<ProjectService> {
    ...
    def "An RLP project with submitted/approved/cancelled report will not be able to change the end date"() {

        setup:
        Map project = [reports:[
                [publicationStatus:ReportService.REPORT_CANCELLED, fromDate:'2017-12-31T13:00:00Z', toDate:'2018-06-30T14:00:00Z'],
                [publicationStatus:ReportService.REPORT_SUBMITTED, fromDate:'2017-06-30T14:00:00Z', toDate:'2018-12-31T13:00:00Z'],
                [publicationStatus:ReportService.REPORT_APPROVED, fromDate:'2017-12-31T13:00:00Z', toDate:'2018-06-30T14:00:00Z'],
                [publicationStatus:ReportService.REPORT_NOT_APPROVED, fromDate:'2018-06-30T14:00:00Z', toDate:'2021-06-30T14:00:00Z']
        ...
        then:
        endDate == '2018-12-30T13:00:00Z'

    }


    def "An RLP project with only completed report will be able to change the end date"() {
